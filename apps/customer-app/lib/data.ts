...
export const products: Product[] = [
  ...
  },
  {
    ...
    description:
      "Water-resistant fitness band with heart rate and sleep tracking",
    price: 59.99,
    image_url: [
      {
  ...
  },
  {
    ...
    name: "Ring Light",
    description:
      "12-inch LED ring light with tripod for photography and videos",
    price: 69.99,
    image_url: [
      {
  ...
  },
  {
    ...
    description:
      "Sonic electric toothbrush with 5 brushing modes and travel case",
    price: 89.99,
    image_url: [
      {
  ...
  },
  {
    ...
    description:
      "WiFi smart thermostat with energy-saving features and app control",
    price: 179.99,
    image_url: [
      {
  ...
  },
  {
    ...
    description:
      "Indoor WiFi security camera with night vision and motion alerts",
    price: 89.99,
    image_url: [
      {
...
export const shops: Shop[] = [
  {
    ...
    memberSince: "2020",
    description:
      "Scandinavian-inspired furniture and home decor. Quality craftsmanship with minimalist design.",
  ...
  },
  {
    ...
    memberSince: "2019",
    description:
      "Premium home decor and luxury furnishings. Curated collections for sophisticated spaces.",
  ...
  },
  {
    ...
    memberSince: "2021",
    description:
      "Handcrafted wooden furniture made from sustainable materials. Each piece tells a story.",
  ...
  },
  {
    ...
    memberSince: "2018",
    description:
      "Contemporary lighting solutions for modern homes. From minimalist to statement pieces.",
    responseTime: "< 1 hour",
  ...
  },
  {
    ...
    memberSince: "2022",
    description:
      "Soft furnishings, cushions, and textiles to add warmth to any space.",
  ...
  },
  {
    ...
    memberSince: "2020",
    description:
      "Outdoor furniture and garden accessories. Transform your outdoor living space.",
    responseTime: "< 3 hours",
...
export function getProductsByShop(
  ...
  filteredProducts = filteredProducts.filter(
    (p) => p.category.toLowerCase() === shop.category.toLowerCase()
  );
